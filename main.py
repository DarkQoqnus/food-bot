...
async def get_session_string(update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # ساخت سشن جدید برای ادمین (user_id رو None می‌ذاریم تا بعداً خودش bind بشه)
